...
const GENERIC_COUNTIES = [
  "Adams", "Allen", "Beaver", "Benton", "Boone", "Brown", "Butler", "Carroll", "Cass", "Clark", "Clay", "Clinton", "Columbia", "Cook", "Crawford", "Dallas", "Davis", "Decatur", "Delaware", "Dodge", "Douglas", "Fayette", "Floyd", "Franklin", "Fulton", "Grant", "Greene", "Hamilton", "Hancock", "Harris", "Harrison", "Henry", "Highland", "Howard", "Jackson", "Jasper", "Jefferson", "Johnson", "Knox", "Lake", "Lawrence", "Lee", "Lincoln", "Logan", "Madison", "Marion", "Marshall", "Mercer", "Monroe", "Montgomery", "Morgan", "Orange", "Perry", "Pike", "Polk", "Putnam", "Randolph", "Richland", "Scott", "Shelby", "Smith", "Springfield", "Stark", "Summit", "Taylor", "Union", "Vermilion", "Warren", "Washington", "Wayne", "White", "Will", "Williamson", "Wood", "York"
];

const COUNTIES_BY_STATE: Record<string, string[]> = {
  "California": CA_COUNTIES,
  "New York": NY_COUNTIES,
  "Texas": TX_COUNTIES,
  "Florida": FL_COUNTIES,
};

export const getCountiesForState = (state: string): string[] => {
  return COUNTIES_BY_STATE[state] || GENERIC_COUNTIES;
};