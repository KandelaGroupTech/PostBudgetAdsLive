...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    for (let attempt = 0; attempt < maxRetries; attempt++) {
        ...
        and the top 3 cities in the county. For each city, provide the name, population (as a string, e.g. "10,000"), and approximate latitude/longitude coordinates.`,
                config: {
                    systemInstruction: "You are an expert in US local politics and geography. It is currently the year 2026. Provide the MOST RECENT and CURRENT political figures serving as of 2026.",
